...
def fetch_bist_universe(min_avg_volume=250000, max_rows=80, timeout=20):
    payload = {
    ...
    for item in r.json().get("data", []):
        ...
        if sym:
            rows.append({
                "symbol":sym, "name":d[0], "close":d[1], "change":d[2],
                "volume":d[3], "relative_volume":d[4], "rsi":d[5],
                "adx":d[6], "average_volume_30d":d[7],
            })
    return rows
